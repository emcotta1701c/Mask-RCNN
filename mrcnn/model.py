...
# To replace a Lambda layer that defines a tf.Variable
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        # Tensorflow 1.X -> 2.X: https://blog.paperspace.com/mask-r-cnn-tensorflow-2-0-keras/
        # Told to manually set directory here if log directory raises NotFoundError
