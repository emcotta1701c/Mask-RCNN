...
def bi_fpn_graph(C1, C2, C3, C4, C5, config):
    ...
    if "efficientnet" in config.BACKBONE:
        ...
        if num_channels != config.TOP_DOWN_PYRAMID_SIZE:
            print("bi_fpn_graph() error, pyramid size requested does not match model. Can override this.")
            ...
            print("Your chosen pyramid size was:", str(config.TOP_DOWN_PYRAMID_SIZE))
